...
# Check if timefarmtod directory exists
if [ ! -d "timefarmtod" ]; then
    ...
    # Clone the timefarmtod repository
    echo -e "${BLUE}Cloning timefarmtod repository...${NC}"
    git clone https://github.com/rjfahad/timefarmtod.git

    # Change directory to timefarmtod
    echo -e "${BLUE}Navigating to timefarmtod directory...${NC}"
    cd timefarmtod || exit
    ...
    echo -e "${GREEN}timefarmtod is already installed. Navigating to the directory...${NC}"
    cd timefarmtod || exit
